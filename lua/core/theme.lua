...
M.registry = {
  ...
  modus_vivendi_tinted = {
    ...
    plugin_module = "modus-themes",
    setup = {},
    colorscheme = "modus_vivendi_tinted",
    background = "dark",
  },
  ...
  modus_vivendi_tritanopia = {
    ...
    plugin_module = "modus-themes",
    setup = {},
    colorscheme = "modus_vivendi_tritanopia",
    background = "dark",
  },
  ...
  modus_operandi_tinted = {
    ...
    plugin_module = "modus-themes",
    setup = {},
    colorscheme = "modus_operandi_tinted",
    background = "light",
  },
  modus_operandi_deuteranopia = {
    ...
    plugin_module = "modus-themes",
    setup = {},
    colorscheme = "modus_operandi_deuteranopia",
    background = "light",
  },
  modus_operandi_tritanopia = {
    ...
    plugin_module = "modus-themes",
    setup = {},
    colorscheme = "modus_operandi_tritanopia",
    background = "light",
  },
